...
class TennisDataSource:
    ...
    ATP_BASE_URL = "https://raw.githubusercontent.com/jegqwll/tennis_atp_2000_2025/main/"
    ...
    def fetch_combined_data(self) -> pd.DataFrame:
        ...
        try:
            ...
            logger.warning(f"Combined CSV not available: {e}. Falling back to range fetch.")
            return pd.DataFrame()
