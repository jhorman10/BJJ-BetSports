...
export default defineConfig({
    ...
    preview: {
        ...
        proxy: {
            "/api": {
                target: (_c = process.env.VITE_API_PROXY_TARGET) !== null && _c !== void 0 ? _c : "http://localhost:8000",
                changeOrigin: true,
            },
            "/health": {
                target: (_d = process.env.VITE_API_PROXY_TARGET) !== null && _d !== void 0 ? _d : "http://localhost:8000",
                changeOrigin: true,
            },
        },
    },
