...
interface BaseballGameCardProps {
  game: BaseballGameWithPrediction;
}

const BaseballGameCard: React.FC<BaseballGameCardProps> = ({ game }) => {
    ...
    <>
      ...
      >
        <CardContent sx={{ p: 2.5 }}>
          {/* Header: Venue + Day/Night */}
          <Box display="flex" justifyContent="space-between" alignItems="center" mb={2}>
            <Box display="flex" alignItems="center" gap={1}>
              <SportsBaseball sx={{ color: "#f59e0b", fontSize: 18 }} />
            ...
            <Box display="flex" gap={0.5}>
              <Chip
                ...
                size="small"
                sx={{
                  bgcolor: game.day_night === "night" ? "#6366f1" : "#f59e0b",
                  color: "white",
                  fontWeight: 600,
                  fontSize: "0.7rem",
                  height: 22,
          ...
          >
            ...
            <Box display="flex" alignItems="center" gap={0.5}>
              <SportsBaseball sx={{ fontSize: 14, color: "#f59e0b" }} />
